...
import com.lqb.spring.v3.annotation.Service;
import com.lqb.spring.v3.beans.BeanWrapper;
import com.lqb.spring.v3.beans.config.BeanDefinition;
import com.lqb.spring.v3.beans.config.BeanPostProcessor;
import com.lqb.spring.v3.beans.support.BeanDefinitionReader;
...
public class DefaultApplicationContext implements BeanFactory {
    ...
    public DefaultApplicationContext(String configLocations) throws Exception {
